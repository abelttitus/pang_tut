...
{
    std::shared_ptr<Shader> program = std::make_shared<Shader>();
    program->AddShaderFromFile(pangolin::GlSlVertexShader, "/home/abel/pang_tut/Shaders/" + vertex_shader_file, {});
    program->AddShaderFromFile(pangolin::GlSlFragmentShader, "/home/abel/pang_tut/Shaders/" + fragment_shader_file, {});
    program->Link();
    return program;
}
